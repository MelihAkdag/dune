...
DUNE::Tasks::Task* createControlPathCOLAVColavSbmpcILOSTask(const std::string&, DUNE::Tasks::Context&);
DUNE::Tasks::Task* createControlPathCOLAVColavSbmpcNegotiationTask(const std::string&, DUNE::Tasks::Context&);
DUNE::Tasks::Task* createControlPathCOLAVTargetTrackingTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createSimulatorsAISTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Factory::registerStaticTask("Control.Path.COLAV.ColavSbmpcILOS", createControlPathCOLAVColavSbmpcILOSTask);
DUNE::Tasks::Factory::registerStaticTask("Control.Path.COLAV.ColavSbmpcNegotiation", createControlPathCOLAVColavSbmpcNegotiationTask);
DUNE::Tasks::Factory::registerStaticTask("Control.Path.COLAV.TargetTracking", createControlPathCOLAVTargetTrackingTask);
...
DUNE::Tasks::Factory::registerStaticTask("Simulators.AIS", createSimulatorsAISTask);
